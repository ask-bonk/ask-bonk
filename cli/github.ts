...
export function createFile(repo: string, path: string, content: string, message: string, branch: string): boolean {
	try {
...
export function createPR(repo: string, head: string, base: string, title: string, body: string): string | null {
	try {
